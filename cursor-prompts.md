...
- Please refer to the ### Trade section of #requirements-blotter.md.  Using the information provided in that section, please create the entity, repository, service interface, service implementation, REST controller, and unit tests.  Please enforce all constraints described in the documentation.   Add documentation for the service to README.md.  As usual, record the prompt in cursor-prompts.md and log all your actions in cursor-log.md.  Please execute all steps.  I will review it at the end.

- Please refer to the ### Missing APIs section of #requirements-blotter.md.  Please add these two missing APIs.  Please enforce all constraints described in the documentation.   Add documentation for the service to the appropriate sections of the README.md.  As usual, record the prompt in cursor-prompts.md and log all your actions in cursor-log.md.  Please execute all steps. Please ask clarifying questions if these instructions or the requirements are unclear.

- Please create an openapi.yaml file in the project root that contains the full OpenAPI 3.0 specification for this project's API.  Please create the entire file.  You do not need to ask for confirmation between sections.  Please go ahead and create the full file.